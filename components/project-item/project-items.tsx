...
const ProjectItems = () => {
    ...
    return (
        <div>
            ...
            <Form typePage="home"/>
            {programm.map(({title, description, id}) => {
                return <div key={id} className="p-10 text-white font-thin border-b-2 border-color-blue">
                    <h4 className="text-3xl mb-6"> {intl.formatMessage({id: title})} </h4>
                    <p>
            ...
            <div className="p-10 text-white font-thin border-b-1 border-color-white">
                <h4 className="text-3xl mb-6"> {intl.formatMessage({id: 'page.project.pts.expertise.title'})} </h4>
                <p>
